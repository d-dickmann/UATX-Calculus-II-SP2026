...
- Required reading: *[Mosaic Calculus](https://www.mosaic-web.org/MOSAIC-Calculus/)* (MC) by Danny Kaplan
...
- Homeworks are due on Fridays at 11:30a (start of class) via Populi.
...
| --- | --- | --- | --- |
| 1 (Mar 30-Apr 5) | Accumulation, definite integral, FTC foundations | TBD | - |
| 2 (Apr 6-12) | FTC and antiderivative toolkit | TBD | HW1 + Quiz 1 (Fri Apr 10) |
| 3 (Apr 13-19) | Integration techniques (`u`-sub, integration by parts) | TBD | - |
